...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-darker via-dark to-slate-900 flex">
     ...
     Having trouble? <a href="https://t.me/Iacafevtu1" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline inline-flex items-center gap-1">
